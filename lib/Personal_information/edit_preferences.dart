  ...
  Checkbox buildCheckBox(@required Gender gender, bool isChecked) {
    return Checkbox(
      ...
      onChanged: (bool? value) {
        setState(() {
          switch(gender) {
            case Gender.male: isMaleChecked = !isMaleChecked; break;
            case Gender.female: isFemaleChecked = !isFemaleChecked; break;
            case Gender.other: isOtherChecked = !isOtherChecked;
          }
        });
      },
    );
